...
export function Alert(props) { 
    ...
    return <div class={`tw:text-${mapping[props.type]}-800 tw:bg-${mapping[props.type]}-50 tw:flex tw:items-center tw:p-4 tw:mb-4 tw:text-sm tw:rounded-lg tw:max-w-lg tw:m-auto`} role="alert">
